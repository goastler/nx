      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 text-left">
          <SectionHeading as="h2" variant="title">
            Elevating your AI assistant's skills
          </SectionHeading>

          <p className="mt-4 max-w-3xl text-lg text-slate-500 dark:text-slate-400">
            Nx gives your AI assistant the architectural context it needs to
            understand your entire workspace
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          <FeatureCard
            ...
            href="/blog/nx-just-made-your-llm-smarter"
            icon={
              <svg
                className="h-6 w-6"
                viewBox="0 0 24 24"
